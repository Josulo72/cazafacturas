...
const es = {
  ...
  veredicto_ilegible: 'NO LEGIBLE',
  veredicto_ilegible_pie: 'No se han podido leer los importes: no se puede decir si cuadra.',
...
const en = {
  ...
  veredicto_ilegible: 'UNREADABLE',
  veredicto_ilegible_pie: 'The amounts could not be read, so there is no telling whether it adds up.',
